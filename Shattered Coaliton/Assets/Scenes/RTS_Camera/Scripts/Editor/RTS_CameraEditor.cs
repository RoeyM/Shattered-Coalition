...
namespace RTS_Cam
{
    ...
    public class RTS_CameraEditor : Editor
    {
        ...
        private void MovementTab()
        {
            ...
            if (camera.limitMap)
            {
                camera.limitMinX = EditorGUILayout.FloatField("Limit Min X: ", camera.limitMinX);
                camera.limitMinY = EditorGUILayout.FloatField("Limit Min Y: ", camera.limitMinY);
				camera.limitMaxX = EditorGUILayout.FloatField("Limit Max X: ", camera.limitMaxX);
				camera.limitMaxY = EditorGUILayout.FloatField("Limit Max Y: ", camera.limitMaxY);
            }
