...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public float limitMinX = 20f; //x limit of map
        public float limitMinY = 20f; //z limit of map
		public float limitMaxX = 20f; //x limit of map
		public float limitMaxY = 20f; //z limit of map
        ...
        private void LimitPosition()
        {
            ...
            m_Transform.position = new Vector3(Mathf.Clamp(m_Transform.position.x, limitMinX, limitMaxX),
                m_Transform.position.y,
                Mathf.Clamp(m_Transform.position.z, limitMinY, limitMaxY));
        }
